...
# Exploratory Data Analysis Program Asignment 1
...
* Download the scripts (plot1.R, plot2.R, plot3.R, plot4.R) to the work directory;
* Download the data from here: https://d396qusza40orc.cloudfront.net/exdata%2Fdata%2Fhousehold_power_consumption.zip;
* Extract the data into the work directory;
* Run the scripts
